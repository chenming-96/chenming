...
<script>
  ...
  import panel from "../../components/jurisdiction/panel"
  import selectTree from "../../components/jurisdiction/selectTree.vue"
  import treeter from "../../components/jurisdiction/treeter"
  import * as sysApi from '../../components/jurisdiction/sys'
  ...
  export default {
    ...
    methods: {
      configRoleResources(){
        ...
        this.$http.get("/sys/role/setResources?roleId=" + this.form.id + "&resourceIds="+checkedKeys.join(','))
          .then(res => {
            this.$message('修改成功');
      ...
      batchDelete(){
        ...
        this.$confirm('确定删除?', '提示', {
          ...
          this.$http.get("/sys/role/delete?roleIds=" + checkKeys.join(','))
            .then(res => {
              this.$message('操作成功');
              this.load();
            }).catch(e => {
      ...
      onSubmit(){
        ...
        this.$http.post("/sys/role/add", this.form)
          .then(res => {
      ...
      deleteSelected(id){
        this.$http.get("/sys/role/delete?roleIds=" + id)
          .then(res => {
            this.$message('操作成功');
      ...
      settingResource(event,id){
        ...
        this.$http.get("/sys/role/resources?id=" + id)
          .then(res => {
