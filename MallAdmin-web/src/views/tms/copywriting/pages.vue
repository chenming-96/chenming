<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="文案名称：">
            <el-input v-model="listQuery.keyword" class="input-width" placeholder="文案名称" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px">文案添加</el-button>
    ...
    <div class="table-container">
      <el-table ref="flashTable"
        ...
        <el-table-column label="文案名称" align="center">
          <template slot-scope="scope">{{scope.row.title}}</template>
        </el-table-column>
        <el-table-column label="文案内容" width="140" align="center">
    ...
    <el-dialog
      ...
      <el-form :model="flashPromotion"
        ...
        <el-form-item label="文案标题：">
          ...
          <el-input v-model="flashPromotion.status" style="width: 250px"></el-input>
        </el-form-item>
